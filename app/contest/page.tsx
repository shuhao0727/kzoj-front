...
const contestData: {
  ...
  {
    id: 5,
    title: "23/7/13暑假适应性练习5",
    type: "私有赛",
    status: "已结束",
    date: "2024-07-13 08:30:00",
    duration: "3.5小时",
    contestType: "OI",
    ended: true,
  },
      ...
      <div className="space-y-4">
        {contestData
          ...
          .map((contest) => (
            <div
              key={contest.id}
              className="border p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white flex justify-between items-center"
            >
              <div className="flex items-center space-x-4">
                {/* 图标和标题 */}
                <div>
                  <img
                    src="https://example.com/trophy-icon.png"
                    alt="Trophy"
