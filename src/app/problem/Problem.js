...
const ProblemList = () => {
  const [problems, setProblems] = useState([
    { id: 'P1000', title: 'Hello, World!', difficulty: '入门', total: 546, acRate: '38.46%' },
    { id: 'P1001', title: '地球人口承载力估计', difficulty: '入门', total: 158, acRate: '31.65%' },
    { id: 'P1002', title: '输出第二个整数', difficulty: '入门', total: 209, acRate: '55.02%' },
    { id: 'P1003', title: '对齐输出', difficulty: '入门', total: 71, acRate: '53.52%' },
    { id: 'P1005', title: '计算(a+b)xc的值', difficulty: '入门', total: 180, acRate: '60.56%' },
    { id: 'P1006', title: '带余除法', difficulty: '入门', total: 49, acRate: '87.76%' },
    { id: 'P1007', title: '计算(a+b)/c的值', difficulty: '入门', total: 101, acRate: '81.19%' },
    { id: 'P1008', title: '计算多效蒸发浮点数', difficulty: '入门', total: 32, acRate: '78.13%' },
    { id: 'P1009', title: '流感感染率', difficulty: '入门', total: 27, acRate: '74.07%' },
    { id: 'P1010', title: '计算多项式的值', difficulty: '入门', total: 70, acRate: '45.71%' },
  ]);
    ...
    <div className="container mx-auto p-6 space-y-6 bg-gray-50 rounded-lg shadow-md">
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-300">HDU</button>
          <button className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-300">Codeforces</button>
          <button className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-300">POJ</button>
          <button className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-300">GYM</button>
          <button className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-300">AtCoder</button>
        </div>
      </div>
    </div>
  );
