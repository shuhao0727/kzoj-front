...
const rankingData = [
  { id: 1, username: 'fishk', score: 4135, passed: 184, total: 451, rate: 40.8, nickname: '校队' },
  { id: 2, username: 'zansy', score: 4107, passed: 223, total: 494, rate: 45.14, nickname: '校队' },
  { id: 3, username: 'libc', score: 2464, passed: 104, total: 377, rate: 27.59, nickname: '校队' },
  { id: 4, username: 'henpolorAC', score: 2344, passed: 86, total: 308, rate: 27.60, nickname: '运维' },
  { id: 5, username: 'azwosile', score: 2139, passed: 223, total: 553, rate: 40.33, nickname: '校队' },
  { id: 6, username: '袁守宏', score: 2104, passed: 291, total: 674, rate: 43.18, nickname: '校队' },
  { id: 7, username: 'some_y', score: 1388, passed: 129, total: 461, rate: 27.98, nickname: '校队' },
  { id: 8, username: '龙飞(龙再生)', score: 1294, passed: 154, total: 564, rate: 27.30, nickname: '校队' },
  { id: 9, username: 'shikexin210', score: 1049, passed: 89, total: 354, rate: 25.14, nickname: '' },
  { id: 10, username: 'guchenhang', score: 895, passed: 78, total: 289, rate: 26.99, nickname: '' },
];
...
const Ranking = () => {
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 rounded-lg shadow-md"> {/* 设置背景和阴影 */}
      <h1 className="text-3xl font-semibold text-center text-gray-800 mb-6">OI 排行榜</h1>

      {/* 柱状图 */}
      <div className="mb-6 w-full">
        <div className="relative" style={{ height: '400px' }}>  {/* 高度为400px，宽度根据页面变化 */}
      ...
      {/* 排行榜表格 */}
      <table className="min-w-full table-auto bg-white shadow-lg rounded-lg">  {/* 表格宽度设置为全宽，添加阴影和圆角 */}
        <thead className="bg-gray-200 text-center">  {/* 表头居中 */}
          <tr>
        ...
        <tbody className="text-center text-gray-700">  {/* 表内容居中 */}
          {topTenRankingData
            .filter(
              (user) =>
            ...
            .map((user, index) => (
              <tr key={user.id} className="border-b border-gray-200">
                ...
                <td className="px-4 py-3">{user.nickname ? user.nickname : '无'}</td>
              </tr>
            ))}
        </tbody>
      </table>
