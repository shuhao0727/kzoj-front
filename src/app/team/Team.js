...
const teamData = [
  { id: 1, name: 'CSP-J/S', members: 11, type: '私有团队', date: '2023-08-27', owner: 'root' },
  { id: 2, name: 'NOIP团队', members: 7, type: '私有团队', date: '2023-09-24', owner: 'root' },
  // 其他团队数据...
];
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`px-3 py-1 rounded-lg shadow-md ${
              selectedType === '全部' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'
          ...
          <button
            ...
            className={`px-3 py-1 rounded-lg shadow-md ${
              selectedType === '公开团队' ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-700'
            } transition duration-300`}
          >
            公开团队
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-lg shadow-md ${
              selectedType === '保护团队' ? 'bg-yellow-500 text-white' : 'bg-gray-200 text-gray-700'
            } transition duration-300`}
          >
            保护团队
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-lg shadow-md ${
              selectedType === '私有团队' ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-700'
            } transition duration-300`}
          >
            私有团队
          </button>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-500">成员: {team.members} | 类型: {team.type}</p>
              </div>
            </div>
